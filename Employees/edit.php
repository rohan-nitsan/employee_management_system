                ...
                <div class="col-12 col-lg-9 col-xl-7">
                    <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
                        <div class="card-body p-4 p-md-5">
                            <h1 class="mb-4 pb-2 pb-md-0 mb-md-5">Update Employee Details</h1>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="form-outline">
                                            ...
                                            <input type="text" name="fname" class="form-control form-control-lg" value="<?php echo $data['fname']; ?>" />
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <div class="form-outline">
                                            ...
                                            <input type="text" name="lname" class="form-control form-control-lg" value="<?php echo $data['lname']; ?>" />
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-4">
                                        ...
                                        <div class="form-outline datepicker w-100">
                                            ...
                                            <input type="text" class="form-control form-control-lg" name="address" value="<?php echo $data['address']; ?>" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-4 pb-2">
                                        ...
                                        <div class="form-outline">
                                            ...
                                            <input type="number" name="hsc" class="form-control form-control-lg" value="<?php echo $data['hsc']; ?>" />
...
if (isset($_POST['update'])) {
    ...
    if (empty($fname)) {
        ...
        ";
    } else if (empty($day) or empty($month) or empty($year)) {
        echo "
            <script>
        ...
        echo "
            <script>
                document.getElementById('lname_error').innerText='* Please Enter HSC Percentage';
            </script>
        ";
    } else {
        update($id, $fname, $lname, $address, $gender, $email, $day, $month, $year, $hsc);
    }
}
?>